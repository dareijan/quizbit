function printForm() {
    ...
    try {
        ...
        let v_1_0 = document.forms["quizgenform"]["1_kysymys_vastaus"].value;
        ...
        let v_6_0 = document.forms["quizgenform"]["2_kysymys_vastaus"].value;
        ...
        let v_11_0 = document.forms["quizgenform"]["3_kysymys_vastaus"].value;
        ...
        let v_16_0 = document.forms["quizgenform"]["4_kysymys_vastaus"].value;
        ...
        let v_21_0 = document.forms["quizgenform"]["5_kysymys_vastaus"].value;
        ...
        let v_26_0 = document.forms["quizgenform"]["6_kysymys_vastaus"].value;
        ...
        let v_31_0 = document.forms["quizgenform"]["7_kysymys_vastaus"].value;
        ...
        let v_36_0 = document.forms["quizgenform"]["8_kysymys_vastaus"].value;
        ...
        let v_41_0 = document.forms["quizgenform"]["9_kysymys_vastaus"].value;
        ...
        let v_46_0 = document.forms["quizgenform"]["10_kysymys_vastaus"].value;

        let v_51 = document.forms["quizgenform"]["11_muuttuja"].value;

        let output = 'const ' + v_51 + ' = [{"question": "' + v_1 + '", "answers": { "a": "' + v_2 + '", "b": "' + v_3 + '", "c": "' + v_4 + '", "d": "' + v_5 + '" }, "correctAnswer": "' + v_1_0 + '"}, {"question": "' + v_6 + '", "answers": { "a": "' + v_7 + '", "b": "' + v_8 + '", "c": "' + v_9 + '", "d": "' + v_10 + '" }, "correctAnswer": "' + v_6_0 + '"}, {"question": "' + v_11 + '", "answers": { "a": "' + v_12 + '", "b": "' + v_13 + '", "c": "' + v_14 + '", "d": "' + v_15 + '" }, "correctAnswer": "' + v_11_0 + '"}, {"question": "' + v_16 + '", "answers": { "a": "' + v_17 + '", "b": "' + v_18 + '", "c": "' + v_19 + '", "d": "' + v_20 + '" }, "correctAnswer": "' + v_16_0 + '"}, {"question": "' + v_21 + '", "answers": { "a": "' + v_22 + '", "b": "' + v_23 + '", "c": "' + v_24 + '", "d": "' + v_25 + '" }, "correctAnswer": "' + v_21_0 + '"}, {"question": "' + v_26 + '", "answers": { "a": "' + v_27 + '", "b": "' + v_28 + '", "c": "' + v_29 + '", "d": "' + v_30 + '" }, "correctAnswer": "' + v_26_0 + '"}, {"question": "' + v_31 + '", "answers": { "a": "' + v_32 + '", "b": "' + v_33 + '", "c": "' + v_34 + '", "d": "' + v_35 + '" }, "correctAnswer": "' + v_31_0 + '"}, {"question": "' + v_36 + '", "answers": { "a": "' + v_37 + '", "b": "' + v_38 + '", "c": "' + v_39 + '", "d": "' + v_40 + '" }, "correctAnswer": "' + v_36_0 + '"}, {"question": "' + v_41 + '", "answers": { "a": "' + v_42 + '", "b": "' + v_43 + '", "c": "' + v_44 + '", "d": "' + v_45 + '" }, "correctAnswer": "' + v_41_0 + '"}, {"question": "' + v_46 + '", "answers": { "a": "' + v_47 + '", "b": "' + v_48 + '", "c": "' + v_49 + '", "d": "' + v_50 + '" }, "correctAnswer": "' + v_46_0 + '"}]';
